...

{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string[,] sMatrizDeClientes = new string[100, 5];
           // string[,]sMatrizDeClientes = { { "086.248.766-80", "Joao", "546483330", "Belo Horizonte" }, { "088.258.766-80", "Marcia", "5999483330", "Belo Horizonte" }, { "086.248.644-80", "Pedro", "599980", "Belo Horizonte" } };
            ...
            MetodosDeInicializacao.MenuLogin(sArrayDeLoginDeUsuarios, sArrayDeSenhaDeUsuarios, sArrayDeUsuariosBloqueados, tentativasDeLogin, ref posicaoBloqueados, sMatrizDeProdutos, ref linhaMatrizProdutos, ref linhaMatrizClientes, sMatrizDeClientes, ref linhaMatrizFuncionarios, sMatrizDeFuncionarios);
