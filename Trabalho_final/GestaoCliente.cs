...
namespace CineTech
{
    class GestaoCliente
    {
        ...
        public void GestaoDeCliente(string pUsuario, string pSenha, string[] spArrayDeLoginDeUsuarios, string[] spArrayDeSenhaDeUsuarios, int pTentativasDeLogin, string[] spArrayDeUsuariosBloquiados, ref int posicao, string[,] spMatrizDeProdutos, ref int plinhaMatrizProdutos, string[,] spMatrizDeClientes, ref int plinhaMatrizClientes, ref int plinhaMatrizFuncionarios, string[,] spMatrizDeFuncionarios)
        {
            ...
            Console.WriteLine();
            Console.WriteLine("F1) Cadastrar novo cliente.");
            Console.WriteLine();
            Console.WriteLine("F2) Editar cadastro de cliente.");
            Console.WriteLine();
            Console.WriteLine("F3) Excluir cadastro de cliente.");
            Console.WriteLine();
            Console.WriteLine("F4) Consultar clientes cadastrados.");
            Console.WriteLine();
            ...
            switch (lertecla.Key)
            {
                ...
                case ConsoleKey.F4:
                    {
                        ConsultarCliente(pUsuario, pSenha, spArrayDeLoginDeUsuarios, spArrayDeSenhaDeUsuarios, pTentativasDeLogin, spArrayDeUsuariosBloquiados, ref posicao, spMatrizDeProdutos, ref plinhaMatrizProdutos, ref plinhaMatrizClientes, spMatrizDeClientes, ref plinhaMatrizFuncionarios, spMatrizDeFuncionarios);
                        break;
            ...
            for (int i = 0; i < spMatrizDeClientes.GetLength(0); i++)
            {
                if (spMatrizDeClientes[i, 0] == editar)
                {
                    ...
                    switch (lertecla.Key)
                    {
                        ...
                        case ConsoleKey.F4:
                            {
                                Console.Write("Informe a nova cidade do cliente: ");
                                cidade = Console.ReadLine();
                                spMatrizDeClientes[plinhaMatrizClientes, 4] = cidade;
                                break;
                            }
        ...
        public void ExcluirCliente(ref int plinhaMatrizClientes, string[,] spMatrizDeClientes)
        {
            ...
            if (contexcluir == 0)
            {
                Console.WriteLine("Cadastro de cliente não encontrado.");
                Console.WriteLine();
                Console.WriteLine("Pressione qualquer tecla para retornar ao menu de gestão de gestão de cliente.");
                Console.ReadKey();
            }
        }
        public void ConsultarCliente(string pUsuario, string pSenha, string[] spArrayDeLoginDeUsuarios, string[] spArrayDeSenhaDeUsuarios, int pTentativasDeLogin, string[] spArrayDeUsuariosBloquiados, ref int posicao, string[,] spMatrizDeProdutos, ref int plinhaMatrizProdutos, string[,] spMatrizDeClientes, ref int plinhaMatrizClientes, ref int plinhaMatrizFuncionarios, string[,] spMatrizDeFuncionarios)
        {
            ...
            do
            {
                ...
                switch (lertecla.Key)
                {
                    ...
                    case ConsoleKey.F5:
                        {
                            GestaoDeCliente(pUsuario, pSenha, spArrayDeLoginDeUsuarios, spArrayDeSenhaDeUsuarios, pTentativasDeLogin, spArrayDeUsuariosBloquiados, ref posicao, spMatrizDeProdutos, ref plinhaMatrizProdutos, ref plinhaMatrizClientes, spMatrizDeClientes, ref plinhaMatrizFuncionarios, spMatrizDeFuncionarios);
                            break;
                        }
                }
