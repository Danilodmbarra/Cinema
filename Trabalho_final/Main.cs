...

{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string[,] sMatrizDeVendas = new string[100, 4];
            ...
            MetodosDeInicializacao.MenuLogin(sArrayDeLoginDeUsuarios, sArrayDeSenhaDeUsuarios, sArrayDeUsuariosBloqueados, tentativasDeLogin, ref posicaoBloqueados, sMatrizDeProdutos, ref linhaMatrizProdutos,sMatrizDeClientes,sMatrizDeVendas);
